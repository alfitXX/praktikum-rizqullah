...
public class Main {
    ...
    public static void main(String[] args) {
        // Mengisi stok buku
        bookList[0] = new Book("B1", "Sejarah", 5, "Alfito");
        bookList[1] = new Book("B2", "Sejarah", 10, "Sam Smith");
        bookList[2] = new Book("B3", "Sejarah", 8, "Alice arafah");
    ...
    public static class Student extends User {
        ...
        public Student(String nim, String nama, String fakultas, String programstudi) {
            super(nim);
            this.name = nama;
            this.faculty = fakultas;
            this.studyProgram = programstudi;
        }
